(function() {
  describe('Player', function() {
    ...
    describe('#attack', function() {
      ...
      player1 = new Player();
      player2 = new Player();
      it('increases defending card\'s damage_taken by adjacent attacking card\'s attack', function() {
        player1.field.push(new Card(card));
        player2.field.push(new Card(card2));
        player1.attack(player2);
        expect(player2.damage_taken).toEqual(0);
        return expect(player2.field[0].damage_taken).toEqual(50);
      });
      return it('increases defending player\'s damage_taken by the summed attack of non-adjacent attacking cards', function() {
        player1.field.push(new Card(card));
        player1.attack(player2);
    ...
    return describe('#use_ability', function() {
      ...
      TestAbility = new Ability({
        cmd: function(us, them, damage_amount) {
          return us.take_damage(damage_amount);
        }
      });
